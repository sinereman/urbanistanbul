...
![Swirly Bokeh 4x5.65 Filtresi — SmallRig Mattebox ile](/images/uploads/swirly-bokeh-4x565II.jpg)
...
77mm'den 82mm'ye step up ring ile 24-70mm f/2.8 S'e taktım. Sonuç, 4x5.65 versiyondan farklı: 35mm ile 40mm aralığında swirly bokeh belirginleşiyor. Bu aralığın altında etki ya çok sınırlı kalıyor ya da filtre deseninden ötürü aşırı vinyetleme oluşuyor.

Neden? 82mm filtrenin ön elemana daha yakın oturması ve farklı ışık kesim geometrisi, efektin ortaya çıktığı odak uzaklığını değiştiriyor. Aynı filtre, aynı lens, farklı montaj yöntemi ve farklı sonuç. Bu bir sorun değil, bir özellik. Farklı montaj kombinasyonları farklı efekt karakterleri üretiyor.
...
Bu nedenle filtreyi yeni bir lensle kullanmadan önce birkaç odak uzaklığında test etmek gerekiyor. 35mm'de bak, 40mm'de bak, 70mm'de bak. Swirl'ün en güçlü göründüğü noktayı bul, o aralıkta en açık diyaframa alarak çek. Petzval bir lens aldığınızda bu zoom aralıklar bildiğiniz üzere elinizin altında olmayacak. Bu açıdan filtre hala benim açımdan kazanan seçim olarak öne çıkıyor.
...
Swirly bokeh, fotoğraf tarihinin en ilgi çekici optik karakterlerinden biri. Onlarca yıl boyunca bunu elde etmek için pahalı vintage Petzval lenslerine ihtiyaç duyuldu, otofokus feda edildi.
